...
public class Programa {
	...
	private static void processa(Comparavel[] elementos) {
		imprime(elementos);
		OrdenadorPorSelecao.ordena(elementos);
		imprime(elementos);
	...
	private static void buscaMaior(Comparavel[] elementos) {
		// Busca o maior:
		System.out.println("Maior:");
		Comparavel maior = elementos[elementos.length - 1];
		System.out.println(maior);
	}

	private static void buscaMenor(Comparavel[] elementos) {
		// Busca o menor:
		System.out.println("Menor:");
		Comparavel menor = elementos[0];
		System.out.println(menor);
	}

	private static void buscaMaiores(Comparavel[] elementos) {
		// Busca os 3 maiores:
	...
	private static void buscaMenores(Comparavel[] elementos) {
		// Busca os 3 menores:
